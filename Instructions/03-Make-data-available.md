...
## Task 2: Explore the default datastores
...
1. Using the &#43; **Add container** button at the top of the screen, **create** a new *container* and name it `training-data`.
...
## Task 4: Clone the lab materials
